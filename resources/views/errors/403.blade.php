...
<head>
    ...
    <title>403 — Forbidden — {{ config('app.name', 'Brickspoint Hotel') }}</title>
    @if (setting('favicon'))
    ...
    <div class="error-split">
        <aside class="error-showcase">
            ...
            <div class="max-w-sm text-center">
                ...
                <h3 class="text-white font-semibold text-lg mb-2">Access Restricted</h3>
                <p class="text-white/70 text-sm leading-relaxed">This area requires special authorization. Contact your administrator if you believe you should have access.</p>
            </div>
        ...
        <main class="error-form-panel">
            <div class="error-card">
                ...
                <p class="text-gray-500 text-sm mb-8 leading-relaxed">You don't have permission to access this page. If you think this is a mistake, please contact the site administrator.</p>
