...
<head>
    ...
    <title>500 — Server Error — {{ config('app.name', 'Brickspoint Hotel') }}</title>
    @if (setting('favicon'))
    ...
    <div class="error-split">
        <aside class="error-showcase">
            ...
            <div class="max-w-sm text-center">
                ...
                <p class="text-white/70 text-sm leading-relaxed">Our team has been notified. Please try again in a moment or contact support if the issue persists.</p>
            </div>
        ...
        <main class="error-form-panel">
            <div class="error-card">
                ...
                <p class="text-gray-500 text-sm mb-8 leading-relaxed">Something went wrong on our end. Our team has been automatically notified and is looking into it.</p>
