...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:py-20 px-4 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div class="bg-white py-8 px-6 shadow-lg rounded-2xl sm:px-10 login-card">
            <h1 class="text-center text-2xl font-bold text-gray-900 mb-2">{{ __('Confirm Password') }}</h1>
            <p class="text-center text-gray-600 mb-8 text-sm">{{ __('Please confirm your password before continuing.') }}</p>
